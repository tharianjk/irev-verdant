...
<div id="appbody">
    ...
    <c:forEach items="${model.freqlist}" var="freqlst">
		<tr>
			...
			<td> <input type='text' id='txtlg' value='<c:out value="${freqlst.lineargain}"/>'/> <br>
...
function tabledata()
{
 ...
 $("#save").click(function(e){
		...
		tabledata();
		var url="lineargain.htm?oper=save&testid="+testid+"&frequnit="+frequnit+"&strjsonfreq="+json;
		console.log("url "+url);
		window.location = url;
	});
 $("#cancel").click(function(e){
		...
		tabledata();
		var url="/birt-verdant/frameset?__report=CPGain.rptdesign&testid="+testid;
		console.log("url "+url);
		window.location = url;
	});
</script>
