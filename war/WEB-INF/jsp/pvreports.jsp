		...
		if(document.getElementById('all').checked){
			...
			if(typ=='3db' ){
				if(atype=='P' || atype=='R' ){ //Elevation (pitch or roll)
		         url="/birt-viewer/frameset?__report=verdant/3dbPitchRoll_report.rptdesign&deg="+deg+"&testid="+testid+"&type="+atype+"&rpth="+rptheader+"&rptf="+rptfooter+"&pc="+nprecision;}
				else if (atype=='NCP' || atype=="E"){
					 url="/birt-viewer/frameset?__report=verdant/3db_report.rptdesign&deg="+deg+"&testid="+testid+"&type="+atype+"&rpth="+rptheader+"&rptf="+rptfooter+"&pc="+nprecision;}
				else{
				 url="/birt-viewer/frameset?__report=verdant/3dbWithCP_report.rptdesign&deg="+deg+"&testid="+testid+"&type="+atype+"&rpth="+rptheader+"&rptf="+rptfooter+"&pc="+nprecision;}
			}
			if(typ=='10db' ){
				if(atype=='P' || atype=='R'){ //Elevation or (pitch or roll)
		         url="/birt-viewer/frameset?__report=verdant/10dbPitchRoll_report.rptdesign&deg="+deg+"&testid="+testid+"&type="+atype+"&rpth="+rptheader+"&rptf="+rptfooter+"&pc="+nprecision;}
				else if (atype=='NCP' || atype=="E"){
					 url="/birt-viewer/frameset?__report=verdant/10db_report.rptdesign&deg="+deg+"&testid="+testid+"&type="+atype+"&rpth="+rptheader+"&rptf="+rptfooter+"&pc="+nprecision;}
				else{
				 url="/birt-viewer/frameset?__report=verdant/10dbWithCP_report.rptdesign&deg="+deg+"&testid="+testid+"&type="+atype+"&rpth="+rptheader+"&rptf="+rptfooter+"&pc="+nprecision;}
			}
