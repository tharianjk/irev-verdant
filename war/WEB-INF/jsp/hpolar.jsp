...
if(document.getElementById("freqtype").value=="M"){
	...
	j=0;
			...
			console.log("J "+j);
				...
				if(j==1)
				{
					var url="/birt-verdant/frameset?__report=PolarGeneric.rptdesign&type="+typ+"&testid="+testid+"&scale="+scale+"&max="+max+"&min="+min+"&lgain="+lg+"&img="+img+"&rpth="+rptheader+"&rptf="+rptfooter+"&freq1="+selfreq+
