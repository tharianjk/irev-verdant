...
if(document.getElementById("freqtype").value=="M"){
	...
	j=0;
			...
			console.log("J "+j);
				...
				if(j==1)
				{
					var url="/birt-viewer/frameset?__report=PolarGeneric.rptdesign&type="+typ+"&testid="+testid+"&scale="+scale+"&max="+max+"&min="+min+"&lgain="+lg+"&img="+img+"&rpth="+rptheader+"&rptf="+rptfooter+"&freq1="+selfreq+
				...
				var url="/birt-viewer/frameset?__report=PolarMultiple.rptdesign&typ="+typ+"&testid="+testid+"&strlg="+sellg+"&img="+img+"&rpth="+rptheader+"&rptf="+rptfooter+"&strfreq="+selfreq+"&usr="+uname+"&scale="+scale+"&max="+max+"&min="+min;
		}
		//single
		else{
